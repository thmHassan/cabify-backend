...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::group(['middleware' => ['role:superadmin,subadmin']], function () {
        ...
        Route::get('/super-admin/get-maps-api-count', [SettingController::class, 'getMapsApiCount']);
    });
});
...
Route::group(['middleware' => ['tenant.db', 'auth.tenant.jwt']], function () {
    ...
    Route::get('/company/get-api-keys', [SettingController::class, 'getApiKeys']);
    ...
    Route::get('/company/get-financial-summary', [RevenueFinanceController::class, 'getFinancialSummary']);
    Route::get('/company/get-ride-history', [RevenueFinanceController::class, 'getRideHistory']);
...
Route::group(['middleware' => ['tenant.db']], function () {
    ...
    Route::post('/internal/edit-booking', [BookingController::class, 'editBooking']);
    ...
    Route::group(['middleware' => ['auth.driver.jwt', 'check.app.availibility']], function () {
        ...
        Route::get('/driver/no-show-ride', [DriverBookingController::class, 'noShowRideList']);
