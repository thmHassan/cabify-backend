...
{
    public function test_build_search_query_includes_boundary_country_when_nearby_search_enabled(): void
    {
        $request = Request::create('/company/mapify-search', 'GET', [
            ...
            'lon' => 74.3587,
            'size' => 5,
            'boundary_country' => 'pak',
        ]);

        $query = MapifyQueryBuilder::buildSearchQuery($request, true);
    ...
    public function test_build_search_query_omits_boundary_country_when_nearby_search_disabled(): void
    {
        $request = Request::create('/company/mapify-search', 'GET', [
            'q' => 'Tokyo Japan',
            'size' => 3,
            'boundary_country' => 'JPN',
        ]);
    ...
    public function test_build_geocoding_query_includes_boundary_country_when_nearby_search_enabled(): void
    {
        ...
        $query = MapifyQueryBuilder::buildGeocodingQuery($request, true);
