    ...
    public function createVehicleType(Request $request){
        try{
            $request->validate([
                ...
                'base_fare_less_than_x_price' => Rule::requiredIf($request->base_fare_system_status === 'yes'),
                'base_fare_from_x_miles' => Rule::requiredIf($request->base_fare_system_status === 'yes'),
                'base_fare_to_x_miles' => Rule::requiredIf($request->base_fare_system_status === 'yes'),
                'base_fare_from_to_price' => Rule::requiredIf($request->base_fare_system_status === 'yes'),
                'base_fare_greater_than_x_miles' => Rule::requiredIf($request->base_fare_system_status === 'yes'),
                'base_fare_greater_than_x_price' => Rule::requiredIf($request->base_fare_system_status === 'yes'),
                'mileage_system' => 'required',
                'first_mile_km' => Rule::requiredIf($request->mileage_system === 'fixed'),
                'second_mile_km' => Rule::requiredIf($request->mileage_system === 'fixed'),
